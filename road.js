...
function closebutton5() {
  ...
  alertBox2 = document.getElementById("alertBox2");
  alertBox2.onclick = closeAlertBox2;
}
...
function start() {
  ...
  window.alert2 = function (msg) {
    ...
    alertClose.id = closeId;
    document.body.appendChild(alertClose);
    alertBox.onclick = closeAlertBox2;
  };

  var car1 = new Car({ x: 1600, y: 410 }, "green", "left.1.png");
  var car2 = new Car({ x: 1600, y: 620 }, "red", "left.2.png");
  var car3 = new Car({ x: -100, y: 115 }, "green", "right.1.png");
  var car4 = new Car({ x: -100, y: 25 }, "red", "right.2.png");
  ...
  var myVar = setInterval(() => {
    ...
    if (car3.location.x < 1500) {
      ...
      alert1('The winner is the red car!!!' + `<button class="button button5" onclick="start()">
      <img src="images/race-flag.jpg" alt="Start" height="150"
        width="150"></button>`)
      ...
      alert2("The winner is the green car!!!" + `<button class="button button5" onclick="start()">
      <img src="images/race-flag.jpg" alt="Start" height="150"
        width="150"></button>`)
